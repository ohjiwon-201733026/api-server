...
include::{snippets}/feed-rest-controller-test/create-undefined-non-user-feed/request-body.adoc[]
...
include::{snippets}/feed-rest-controller-test/create-undefined-user-feed/request-body.adoc[]
...
[[create-feed-images-without-feed]]
=== 2.1 피드 이미지 등록 (생성된 피드 없을 경우)

요청 형식

include::{snippets}/image-rest-controller-test/create-feed-images-without-feed/request-parts.adoc[]

응답 정보

include::{snippets}/image-rest-controller-test/create-feed-images-without-feed/response-body.adoc[]

응답 형식

include::{snippets}/image-rest-controller-test/create-feed-images-without-feed/response-fields.adoc[]

[[create-feed-images-with-feed]]
=== 2.2 피드 이미지 등록 (생성된 피드 있을 경우)
...
include::{snippets}/report-rest-controller-test/report-feed/request-parameters.adoc[]
