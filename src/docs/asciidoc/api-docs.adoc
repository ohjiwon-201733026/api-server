...
include::{snippets}/feed-rest-controller-test/get-feed-categories/http-request.adoc[]

응답 정보

include::{snippets}/feed-rest-controller-test/get-feed-categories/response-body.adoc[]

응답 형식

include::{snippets}/feed-rest-controller-test/get-feed-categories/response-fields.adoc[]
