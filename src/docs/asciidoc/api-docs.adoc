...
include::{snippets}/image-rest-controller-test/create-feed-images/request-parameters.adoc[]
include::{snippets}/image-rest-controller-test/create-feed-images/request-parts.adoc[]

응답 정보

include::{snippets}/image-rest-controller-test/create-feed-images/response-body.adoc[]

응답 형식

include::{snippets}/image-rest-controller-test/create-feed-images/response-fields.adoc[]
